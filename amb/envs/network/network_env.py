...
class NetworkEnv:
    def __init__(self, env_args) -> None:
        ...
        self.action_space = [Discrete(self.n_a)] * self.n_agents
        self.observation_space = [[self.n_s] for _ in range(self.n_agents)]
        self.share_observation_space = [[self.n_s] for _ in range(self.n_agents)]

...
from rlplotter import plot_utils as pu
import matplotlib
...
def main():
	...
	parser.add_argument('--fig_length', type=int, default=4,
						help='matplotlib figure length (default: 6)')
	parser.add_argument('--fig_width', type=int, default=3,
	...
	parser.add_argument('--ylabel', default='Adversary Reward',
	...
	parser.add_argument('--avg_group', action='store_false',
						help='average the curves in the same group and plot the mean.')
	parser.add_argument('--shaded_std', action='store_false',
	...
	parser.add_argument('--no_legend_group_num', action='store_false',
	...
	if args.save:
		plt.savefig(args.title.lower().replace(" ", "") + '.pdf', format='pdf', dpi=1200, bbox_inches='tight')
		# plt.savefig(args.log_dir + 'figure' + '.eps', format='eps', bbox_inches='tight')
		# plt.savefig(args.log_dir + 'figure' + '.svg', format='svg', dpi=1200, bbox_inches='tight')
	if args.show:
		plt.show()

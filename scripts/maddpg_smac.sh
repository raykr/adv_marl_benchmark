...
python -u ../single_train.py --env smac --env.map_name 3m --algo maddpg --run single --exp_name nstep_20 --algo.n_step 20
...
python -u ../single_train.py --env smac --env.map_name 3s_vs_5z --algo maddpg --run single --exp_name nstep_20 --algo.n_step 20
